...
- **Keep-Alive**: If no messages have been sent in the past 7 days, the application will automatically send a text 
  message to the `RELAY_TO_NUMBER` at 10 AM to prevent the Twilio number from being reclaimed.
